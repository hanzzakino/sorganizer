      ...
      <main>
        <div className='text-container'>
          <div className={settings.general.theme+'-fgcolor'}>
            ...
            <li>
            <p><strong>Website</strong> refers to SOrganizer, accessible from <a href='https://sorganizer.vercel.app'>https://sorganizer.vercel.app</a></p>
            </li>
            <li>
            ...
            <li>
            <p>By visiting this page on our website: <a href='https://sorganizer.vercel.app'>https://sorganizer.vercel.app</a></p>
            </li>
            </ul>
          </div>
        </div>
